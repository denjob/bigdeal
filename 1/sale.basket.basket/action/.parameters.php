...
$arTemplateParameters['MY_SET_ACTION'] = array(
	'PARENT' => 'ADDITIONAL_SETTINGS',
	'NAME' => GetMessage('MY_SET_ACTION'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);

$arTemplateParameters['MY_PERIOD_BEGIN'] = array(
	'PARENT' => 'ADDITIONAL_SETTINGS',
	'NAME' => GetMessage('MY_PERIOD_BEGIN'),
	'TYPE' => 'CUSTOM',
	'JS_FILE' => $templateFolder.'/js/settings.js',
	'JS_EVENT' => 'OnMySettingsEdit',
	'JS_DATA' => json_encode(array('btn' => GetMessage('MY_PERIOD_BEGIN_BTN'))),
	'DEFAULT' => date('d.m.Y',(time()-3600*24)),
);

$arTemplateParameters['MY_PERIOD_END'] = array(
	'PARENT' => 'ADDITIONAL_SETTINGS',
	'NAME' => GetMessage('MY_PERIOD_END'),
	'TYPE' => 'CUSTOM',
	'JS_FILE' => $templateFolder.'/js/settings.js',
	'JS_EVENT' => 'OnMySettingsEdit',
	'JS_DATA' => json_encode(array('btn' => GetMessage('MY_PERIOD_END_BTN'))),
	'DEFAULT' => date('d.m.Y',(time()+3600*24)),
);

$arTemplateParameters['MY_EVERY'] = array(
	'PARENT' => 'ADDITIONAL_SETTINGS',
	'NAME' => GetMessage('MY_EVERY'),
	'TYPE' => 'STRING',
	'DEFAULT' => '2'
);

$arTemplateParameters['MY_EVERY_PRICE'] = array(
	'PARENT' => 'ADDITIONAL_SETTINGS',
	'NAME' => GetMessage('MY_EVERY_PRICE'),
	'TYPE' => 'STRING',
	'DEFAULT' => '1'
);
