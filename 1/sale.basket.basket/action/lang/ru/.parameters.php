...
$MESS["CP_SBB_TPL_BRAND_PROPERTY"] = "Свойство брендов";
$MESS["EMPTY_BASKET_HINT_PATH_TIP"] = "Ссылка для продолжения покупок отображается в случае если корзина пуста.<br>При условии, что путь пустой, текст не будет отображен.";
$MESS['MY_SET_ACTION'] = 'Включить акцию каждый N товар по X рублей?';
$MESS['MY_PERIOD_BEGIN'] = 'Начало периода действия акции';
$MESS['MY_PERIOD_END'] = 'Конец периода действия акции';
$MESS['MY_EVERY'] = 'Каждый N';
$MESS['MY_EVERY_PRICE'] = 'по X';
$MESS['MY_PERIOD_BEGIN_BTN'] = 'Начало периода';
$MESS['MY_PERIOD_END_BTN'] = 'Конец периода';
?>